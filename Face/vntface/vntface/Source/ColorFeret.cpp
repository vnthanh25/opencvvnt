...
std::vector<int> ColorFeret::aGetsAllPose1(const std::string pId)
{
...
//\\ Lay to hop cac pose tuong ung voi goc nhin trong ten file.
std::vector<std::string> ColorFeret::aGetsAllPose2(const std::string pId)
{
	std::vector<std::string> result;
	std::string fName = mImageName;
	//\\ Lay tat ca Date.
...
//\\ Lay to hop cac pose tuong ung voi goc nhin trong ten file.
std::vector<std::string> ColorFeret::aGetsAllPoseName(const std::string pId)
{
	std::vector<std::string> result;
	std::string fName = mImageName;
	//\\ Lay tat ca Date.
