...
//\\ Khoi tao features.
void aMeanCosHeadPoseFeaturesInit()
{
	Utilites util;
	//\\ Hien thi thoi gian bat dau.
	cout << "aMeanCosVNTDataSetInit: " << util.currentDateTime() << std::endl;
	...
	//\\ Khoi tao features.
	vFaceTrackDB.aFeatureInit(vFaceDataSet.aGetFaceTraks(), vFaceDataSet.aGetPoses(), vDataSetPath);
...
void aMeanCosDatabaseInitDivNotPose()
{
	...
	//\\ Khoi tao csdl.
	vFaceTrackDB.aDatabaseInitNotPose(vFaceTrackDB.aGetFacetrackFeatures(), vDataSetPath);
...
int main(void)
{
	...
	//aMeanCosMAPDiv();//\\ Database: 0.176732. Vector dac trung trung binh cua facetrack query duoc lay tu trong csdl.
	aMeanCosMAPDiv();//\\ DatabaseNotPose: 0.997037. Vector dac trung trung binh cua facetrack query duoc lay tu trong csdl.
